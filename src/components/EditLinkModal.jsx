    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-xl w-full max-w-xs sm:max-w-lg md:max-w-2xl max-h-[98vh] sm:max-h-[90vh] overflow-y-auto"
        >
